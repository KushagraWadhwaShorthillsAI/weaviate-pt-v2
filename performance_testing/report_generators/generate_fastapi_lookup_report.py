...
def scan_fastapi_lookup_reports():
    ...
    # Search types for FastAPI lookup
    search_types = ['graphql_lookup_sync', 'graphql_lookup_async']
...
<body>
    <div class="header">
        ...
        <div class="subtitle">
            Comprehensive analysis: Sync Lookup vs Async Lookup across different user counts<br>
            RF: """ + rf_value + """ | Limit: """ + limit + """ | Query Type: Hybrid (alpha=0.9)<br>
...
"""
        ...
        for search_type, display_name in [
            ('graphql_lookup_sync', 'Sync Lookup (/graphql/lookup)'),
            ('graphql_lookup_async', 'Async Lookup (/graphql/async/lookup)')
        ]:
